    ...
    child:RaisedButton(
      ...
      child: Row(
        children:<Widget>[
          ...
          Icon(CupertinoIcons.arrow_3_trianglepath, color: Color(0xffff2fc3),),
          SizedBox(width: 10),
        ...
        EdgeInsets.only(top: 5,left: 20,right: 20),
          child:RaisedButton(
            ...
            child: Row(
                children:<Widget>[
                  // we need to import cupertino_icons
                  Icon(CupertinoIcons.f_cursive_circle_fill, color: Color(0xffff2fc3),),
                  SizedBox(width: 10),
                  Text("Sign In With Google",style: TextStyle(
                      fontSize: 20,color: Color(0xff000725)
                  ),)
          ...
          color: Colors.white
           ...
           FlatButton(onPressed: () {
             Navigator.of(context).pushReplacement(
               MaterialPageRoute(builder: (BuildContext context)=> SingUpScreen())
             );
              },
            child: Column(
              children: <Widget>[
